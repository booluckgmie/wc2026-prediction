...
const PROFILE = {
  "Brazil":        {xgOff:2.1,xgDef:0.6,style:"Total Football",   col:"#009c3b",r:{k:88,q:91,ro:86,b:89,kn:84,p:82},pl:["Vinicius Jr ★5.0","Endrick ★4.5","Rodrygo ★4.2","Casemiro ★4.3"]},
  "France":        {xgOff:2.3,xgDef:0.9,style:"Counter-Attack",   col:"#002395",r:{k:87,q:93,ro:88,b:85,kn:86,p:84},pl:["Mbappé ★5.0","Griezmann ★4.6","Camavinga ★4.3","Saliba ★4.4"]},
  "Argentina":     {xgOff:2.2,xgDef:0.8,style:"Tiki-Counter",     col:"#74acdf",r:{k:85,q:94,ro:84,b:86,kn:83,p:81},pl:["Messi ★5.0","J.Álvarez ★4.5","Mac Allister ★4.3","Otamendi ★4.2"]},
  "England":       {xgOff:2.3,xgDef:1.1,style:"High Press",       col:"#cf111b",r:{k:86,q:88,ro:87,b:84,kn:87,p:89},pl:["Bellingham ★4.8","Saka ★4.6","Kane ★4.7","Alexander-Arnold ★4.4"]},
  "Spain":         {xgOff:2.0,xgDef:0.7,style:"Possession",       col:"#c60b1e",r:{k:85,q:87,ro:86,b:91,kn:88,p:87},pl:["Pedri ★4.7","Yamal ★4.6","Morata ★4.3","Rodri ★4.8"]},
  "Germany":       {xgOff:2.2,xgDef:0.9,style:"Pressing",         col:"#555",   r:{k:84,q:86,ro:85,b:84,kn:87,p:88},pl:["Musiala ★4.7","Wirtz ★4.6","Havertz ★4.4","Rüdiger ★4.3"]},
  "Portugal":      {xgOff:1.9,xgDef:1.0,style:"Wing Dominance",   col:"#006600",r:{k:84,q:90,ro:88,b:83,kn:84,p:82},pl:["Ronaldo ★4.5","B.Fernandes ★4.6","Leão ★4.4","Dias ★4.5"]},
  "Netherlands":   {xgOff:2.3,xgDef:1.2,style:"Total Football",   col:"#ff6600",r:{k:85,q:87,ro:86,b:85,kn:86,p:83},pl:["Gakpo ★4.5","De Jong ★4.4","Dumfries ★4.2","Van Dijk ★4.6"]},
  "Belgium":       {xgOff:1.2,xgDef:0.9,style:"Individual Quality",col:"#222",  r:{k:83,q:85,ro:82,b:83,kn:84,p:80},pl:["De Bruyne ★4.7","Lukaku ★4.4","Tielemans ★4.2","Courtois ★4.5"]},
  "Mexico":        {xgOff:1.5,xgDef:0.8,style:"Counter + Block",  col:"#006847",r:{k:83,q:80,ro:82,b:79,kn:81,p:85},pl:["Lozano ★4.2","Guardado ★3.9","Ochoa ★4.3","Herrera ★4.0"]},
  "United States": {xgOff:2.0,xgDef:0.8,style:"Athletic Press",   col:"#b22234",r:{k:82,q:83,ro:84,b:79,kn:85,p:86},pl:["Pulisic ★4.4","McKennie ★4.1","Musah ★4.2","Turner ★4.0"]},
  "Canada":        {xgOff:1.8,xgDef:0.9,style:"High Line",        col:"#ff0000",r:{k:80,q:82,ro:81,b:78,kn:82,p:83},pl:["Davies ★4.6","David ★4.4","Buchanan ★4.1","Borjan ★3.9"]},
  "Japan":         {xgOff:2.0,xgDef:1.0,style:"Gegenpress",       col:"#003087",r:{k:82,q:80,ro:81,b:82,kn:83,p:84},pl:["Doan ★4.2","Kubo ★4.4","Mitoma ★4.3","Endo ★4.2"]},
  "Morocco":       {xgOff:1.2,xgDef:0.7,style:"Counter-Press",    col:"#c1272d",r:{k:84,q:79,ro:83,b:78,kn:82,p:84},pl:["Ziyech ★4.3","En-Nesyri ★4.2","Hakimi ★4.5","Aguerd ★4.1"]},
  "Uruguay":       {xgOff:1.5,xgDef:1.2,style:"Garra Charrúa",   col:"#5aaae7",r:{k:83,q:82,ro:81,b:79,kn:82,p:83},pl:["Núñez ★4.4","Valverde ★4.5","Bentancur ★4.2","Araújo ★4.4"]},
  "Colombia":      {xgOff:2.0,xgDef:1.0,style:"Transition",       col:"#ffd700",r:{k:81,q:84,ro:82,b:83,kn:82,p:81},pl:["L.Díaz ★4.5","J.Cuadrado ★4.1","Arias ★4.0","Cuesta ★4.1"]},
  "Croatia":       {xgOff:1.6,xgDef:1.3,style:"Midfield Control", col:"#cc0000",r:{k:82,q:80,ro:81,b:86,kn:85,p:80},pl:["Modrić ★4.5","Kovačić ★4.3","Kramarić ★4.2","Gvardiol ★4.4"]},
  "Senegal":       {xgOff:1.3,xgDef:1.3,style:"Athletic Press",   col:"#00853f",r:{k:81,q:82,ro:81,b:78,kn:80,p:82},pl:["Mané ★4.4","Gueye ★4.1","Diatta ★3.9","Koulibaly ★4.3"]},
  "Ecuador":       {xgOff:1.0,xgDef:1.1,style:"Press + Counter",  col:"#ffd100",r:{k:78,q:79,ro:78,b:77,kn:78,p:80},pl:["V.Caicedo ★4.2","Plata ★3.9","Preciado ★3.8","Hincapié ★4.0"]},
  "Iran":          {xgOff:1.3,xgDef:1.2,style:"Low Block",        col:"#239f40",r:{k:79,q:76,ro:77,b:75,kn:77,p:79},pl:["Taremi ★4.1","Jahanbakhsh ★3.9","Pouraliganji ★3.8","Beiranvand ★3.9"]},
  "Saudi Arabia":  {xgOff:0.9,xgDef:1.5,style:"Counter-Attack",   col:"#006c35",r:{k:79,q:77,ro:77,b:76,kn:77,p:79},pl:["Al-Dawsari ★4.0","Al-Shehri ★3.9","Al-Malki ★3.7","Al-Owais ★4.0"]},
  ...
  "Tunisia":       {xgOff:0.8,xgDef:1.5,style:"Compact Block",    col:"#e70013",r:{k:79,q:76,ro:77,b:75,kn:76,p:79},pl:["Msakni ★3.9","Khazri ★3.8","Ben Romdhane ★3.8","Dahmen ★3.9"]},
  "Qatar":         {xgOff:0.8,xgDef:1.5,style:"High Press",       col:"#8d1b3d",r:{k:78,q:76,ro:76,b:75,kn:76,p:78},pl:["Afif ★4.0","Boudiaf ★3.8","Al-Rawi ★3.7","Al-Sheeb ★3.8"]},
  "Panama":        {xgOff:0.9,xgDef:1.2,style:"Compact Defence",  col:"#d90000",r:{k:77,q:74,ro:75,b:73,kn:74,p:77},pl:["Davis ★3.9","Fajardo ★3.7","Murillo ★3.8","Mosquera ★3.7"]},
  "New Zealand":   {xgOff:1.2,xgDef:1.2,style:"Direct Play",      col:"#333",   r:{k:76,q:73,ro:74,b:72,kn:73,p:76},pl:["Wood ★3.8","Boxall ★3.7","Woud ★3.7","Garbett ★3.6"]},
  "South Africa":  {xgOff:1.0,xgDef:1.3,style:"Counter",          col:"#007a4d",r:{k:78,q:76,ro:77,b:75,kn:76,p:78},pl:["Tau ★4.0","Zwane ★3.9","Mothobi ★3.8","Williams ★3.8"]},
  "Algeria":       {xgOff:1.0,xgDef:1.4,style:"Counter-Attack",   col:"#006233",r:{k:79,q:78,ro:77,b:76,kn:77,p:79},pl:["Mahrez ★4.2","Bennacer ★4.1","Slimani ★3.8","M'Bolhi ★3.8"]},
  "Egypt":         {xgOff:1.3,xgDef:1.1,style:"Counter",          col:"#c8102e",r:{k:79,q:78,ro:77,b:76,kn:77,p:79},pl:["Salah ★4.9","Elneny ★3.9","El-Shahat ★3.8","El-Hadary ★3.7"]},
  "Sweden":        {xgOff:1.8,xgDef:1.3,style:"Organised Block",  col:"#006aa7",r:{k:82,q:79,ro:80,b:79,kn:80,p:81},pl:["Isak ★4.4","Kulusevski ★4.3","Ekdal ★4.0","Olsen ★4.0"]},
  "South Korea":   {xgOff:1.2,xgDef:1.0,style:"Wing Speed",       col:"#c60c30",r:{k:80,q:81,ro:82,b:79,kn:82,p:84},pl:["Son ★4.7","Lee Jae-sung ★4.1","Kim Min-jae ★4.4","Hwang ★4.2"]},
  "Australia":     {xgOff:1.4,xgDef:1.1,style:"Direct Play",      col:"#00843d",r:{k:80,q:78,ro:79,b:77,kn:79,p:82},pl:["Leckie ★4.0","Duke ★3.9","Irvine ★3.8","Ryan ★4.0"]},
  "Switzerland":   {xgOff:2.0,xgDef:1.0,style:"Organised Block",  col:"#ff0000",r:{k:83,q:79,ro:80,b:81,kn:81,p:82},pl:["Shaqiri ★4.1","Embolo ★4.0","Xhaka ★4.3","Sommer ★4.2"]},
  "Czech Republic":{xgOff:1.2,xgDef:1.2,style:"Organised Press",  col:"#d7141a",r:{k:80,q:78,ro:79,b:78,kn:79,p:80},pl:["Schick ★4.2","Soucek ★4.1","Kral ★3.9","Vaclik ★3.9"]},
  "Bosnia and Herzegovina":{xgOff:1.1,xgDef:1.4,style:"Counter",  col:"#003da5",r:{k:78,q:77,ro:77,b:76,kn:77,p:79},pl:["Džeko ★4.1","Pjanić ★4.0","Gojak ★3.8","Šehić ★3.7"]},
  "Scotland":      {xgOff:1.1,xgDef:1.1,style:"High Press",       col:"#003366",r:{k:79,q:77,ro:78,b:77,kn:79,p:81},pl:["Robertson ★4.3","McGinn ★4.1","Adams ★3.9","Tierney ★4.0"]},
  "Haiti":         {xgOff:0.7,xgDef:1.5,style:"Defensive Block",  col:"#003087",r:{k:74,q:71,ro:72,b:70,kn:72,p:74},pl:["Martino ★3.5","Angella ★3.4","Dorvil ★3.3","Joseph ★3.5"]},
  "Paraguay":      {xgOff:1.1,xgDef:1.4,style:"Physical Block",   col:"#d52b1e",r:{k:78,q:76,ro:77,b:75,kn:76,p:78},pl:["Almirón ★4.2","Enciso ★4.0","Alonso ★3.8","Silva ★3.8"]},
  "Turkiye":       {xgOff:1.0,xgDef:1.3,style:"Energetic Press",  col:"#e30a17",r:{k:81,q:80,ro:79,b:79,kn:80,p:82},pl:["Calhanoglu ★4.4","Yilmaz ★4.0","Demiral ★4.1","Güler ★4.2"]},
  "Curaçao":       {xgOff:0.8,xgDef:1.5,style:"Counter",          col:"#002b7f",r:{k:74,q:72,ro:73,b:71,kn:72,p:74},pl:["Dos Santos ★3.8","Fer ★3.6","Martina ★3.5","Kwidama ★3.4"]},
  "Norway":        {xgOff:1.8,xgDef:1.0,style:"Counter-Attack",   col:"#ef2b2d",r:{k:81,q:83,ro:80,b:78,kn:80,p:81},pl:["Haaland ★5.0","Ødegaard ★4.6","Ajer ★4.0","Nyland ★3.9"]},
  "Iraq":          {xgOff:0.9,xgDef:1.4,style:"Defensive Block",  col:"#007a3d",r:{k:75,q:73,ro:74,b:72,kn:73,p:75},pl:["Ameen ★3.7","Al-Shammari ★3.6","Al-Haydos ★3.5","Basim ★3.5"]},
  "Austria":       {xgOff:1.6,xgDef:1.0,style:"High Press",       col:"#ed2939",r:{k:80,q:79,ro:78,b:79,kn:80,p:81},pl:["Sabitzer ★4.2","Arnautović ★4.1","Baumgartner ★4.0","Alaba ★4.3"]},
  "Jordan":        {xgOff:0.9,xgDef:1.4,style:"Defensive Counter",col:"#007a3d",r:{k:74,q:71,ro:72,b:70,kn:71,p:73},pl:["Al-Naimat ★3.6","Sharbini ★3.5","Bani Yaseen ★3.4","Abu Zema ★3.5"]},
  "Uzbekistan":    {xgOff:1.0,xgDef:1.3,style:"Organised Press",  col:"#1eb53a",r:{k:76,q:74,ro:75,b:73,kn:74,p:76},pl:["Shomurodov ★3.9","Turgunboev ★3.7","Ergashev ★3.6","Nishonov ★3.6"]},
  "Congo DR":      {xgOff:1.2,xgDef:1.1,style:"Physical Press",   col:"#007fff",r:{k:75,q:73,ro:74,b:72,kn:73,p:75},pl:["Mbemba ★3.8","Bope ★3.6","Kayembe ★3.6","Kasangu ★3.5"]},
